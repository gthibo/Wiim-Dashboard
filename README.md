...
Much of the newer protocol work — the UPnP `GetInfoEx` now-playing path, the loop-mode table, and several source/mode mappings — was informed by [Benjamin Herrenschmidt](https://github.com/ozbenh)'s reverse-engineering and his [`rustywiim`](https://github.com/ozbenh/rustywiim) project. Thanks, Ben. 🙏
